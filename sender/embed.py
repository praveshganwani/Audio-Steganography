...
num = '3'
# Read the Song Input
# song = wave.open("../audios/preamble.wav", mode='rb')

# if image_true:
song = wave.open("../audios/sample"+num+".wav", mode='rb')
...
with wave.open('sample_embedded_img3'+num+'.wav', 'wb') as fd:
...
public_key = rsa_encryption.importKey(open('../rsa/public.pem').read())
